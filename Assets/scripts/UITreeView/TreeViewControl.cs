...
namespace SGK {
    public class TreeViewControl : MonoBehaviour {
        ...
        public ClickItemdelegate onClickEvent;
        ...
        public void GenerateTreeView() {
            ...
            for (int i = 0; i < Data.Count; i++) {
                ...
                if (Data[i].OnClick != null) {
                    item.GetComponent<TreeViewItem>().OnClick = Data[i].OnClick;
                }
                if (Data[i].RefreshItem != null) {
                    item.GetComponent<TreeViewItem>().RefreshItem = Data[i].RefreshItem;
                }

                item.transform.name = "TreeViewItem" + i;
                ...
                item.SetActive(ShowRoot || Data[i].ParentID != -1);
